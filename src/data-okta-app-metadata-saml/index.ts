// https://registry.terraform.io/providers/okta/okta/4.16.0/docs/data-sources/app_metadata_saml
...
export class DataOktaAppMetadataSaml extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppMetadataSaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/data-sources/app_metadata_saml#import import section} in the documentation of this resource for the id to use
