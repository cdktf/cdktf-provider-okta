// https://registry.terraform.io/providers/okta/okta/4.10.0/docs/data-sources/app_saml
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/data-sources/app_saml okta_app_saml}
*/
export class DataOktaAppSaml extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppSaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/data-sources/app_saml#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/data-sources/app_saml okta_app_saml} Data Source
  *
  * @param scope The scope in which to define this construct
