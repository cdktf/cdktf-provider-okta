...
// https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml
...
export interface DataOktaAppSamlConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml#active_only DataOktaAppSaml#active_only}
  */
  readonly activeOnly?: boolean | cdktf.IResolvable;
  /**
  * Id of application to retrieve, conflicts with label and label_prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml#id DataOktaAppSaml#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml#label DataOktaAppSaml#label}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml#label_prefix DataOktaAppSaml#label_prefix}
  */
  readonly labelPrefix?: string;
  /**
  * Denotes whether the request is compressed or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml#request_compressed DataOktaAppSaml#request_compressed}
  */
  readonly requestCompressed?: boolean | cdktf.IResolvable;
  /**
  * Ignore groups sync. This is a temporary solution until 'groups' field is supported in all the app-like resources
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml#skip_groups DataOktaAppSaml#skip_groups}
  */
  readonly skipGroups?: boolean | cdktf.IResolvable;
  /**
  * Ignore users sync. This is a temporary solution until 'users' field is supported in all the app-like resources
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml#skip_users DataOktaAppSaml#skip_users}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml okta_app_saml}
*/
export class DataOktaAppSaml extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppSaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/app_saml okta_app_saml} Data Source
  *
  * @param scope The scope in which to define this construct
