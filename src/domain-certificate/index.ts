// https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/domain_certificate
...
export class DomainCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/domain_certificate#import import section} in the documentation of this resource for the id to use
