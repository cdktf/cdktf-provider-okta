// https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/policy_rule_idp_discovery
...
export class PolicyRuleIdpDiscovery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyRuleIdpDiscovery that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/policy_rule_idp_discovery#import import section} in the documentation of this resource for the id to use
