...
// https://registry.terraform.io/providers/okta/okta/4.15.0/docs/data-sources/network_zone
...
export class DataOktaNetworkZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaNetworkZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.15.0/docs/data-sources/network_zone#import import section} in the documentation of this resource for the id to use
