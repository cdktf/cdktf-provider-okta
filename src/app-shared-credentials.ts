// https://www.terraform.io/docs/providers/okta/r/app_shared_credentials.html
...
export function appSharedCredentialsUsersToTerraform(struct?: AppSharedCredentialsUsers): any {
...
export class AppSharedCredentials extends cdktf.TerraformResource {
  ...
  */
  ...
  private _users?: AppSharedCredentialsUsers[]; 
  public get users() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('users') as any;
  }
  public set users(value: AppSharedCredentialsUsers[]) {
    this._users = value;
  }
  public resetUsers() {
