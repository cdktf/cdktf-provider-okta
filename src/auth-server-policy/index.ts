// https://registry.terraform.io/providers/okta/okta/4.6.2/docs/resources/auth_server_policy
...
export class AuthServerPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthServerPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.2/docs/resources/auth_server_policy#import import section} in the documentation of this resource for the id to use
