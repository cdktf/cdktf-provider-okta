...
// https://registry.terraform.io/providers/okta/okta/4.9.1/docs/data-sources/authenticator
...
export class DataOktaAuthenticator extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAuthenticator that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/data-sources/authenticator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/data-sources/authenticator okta_authenticator} Data Source
  *
  * @param scope The scope in which to define this construct
