// https://registry.terraform.io/providers/okta/okta/4.6.3/docs/data-sources/email_templates
...
export class DataOktaEmailTemplates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaEmailTemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.3/docs/data-sources/email_templates#import import section} in the documentation of this resource for the id to use
