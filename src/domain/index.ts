// https://registry.terraform.io/providers/okta/okta/4.8.0/docs/resources/domain
...
export class Domain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Domain that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.0/docs/resources/domain#import import section} in the documentation of this resource for the id to use
