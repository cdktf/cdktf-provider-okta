// https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/admin_role_targets
...
export class AdminRoleTargets extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminRoleTargets that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/admin_role_targets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/admin_role_targets okta_admin_role_targets} Resource
  *
  * @param scope The scope in which to define this construct
