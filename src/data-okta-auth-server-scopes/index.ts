...
// https://registry.terraform.io/providers/okta/okta/4.11.1/docs/data-sources/auth_server_scopes
...
export class DataOktaAuthServerScopes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAuthServerScopes that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/data-sources/auth_server_scopes#import import section} in the documentation of this resource for the id to use
