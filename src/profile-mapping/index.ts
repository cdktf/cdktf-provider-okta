...
// https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/profile_mapping
...
export class ProfileMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfileMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/profile_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/profile_mapping okta_profile_mapping} Resource
  *
  * @param scope The scope in which to define this construct
