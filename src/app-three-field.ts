// https://www.terraform.io/docs/providers/okta/r/app_three_field.html
...
export interface AppThreeFieldConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly users?: AppThreeFieldUsers[];
}
...
export function appThreeFieldUsersToTerraform(struct?: AppThreeFieldUsers): any {
...
export class AppThreeField extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/okta/r/app_three_field.html okta_app_three_field} Resource
  *
  ...
  */
  ...
  private _users?: AppThreeFieldUsers[]; 
  public get users() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('users') as any;
  }
  public set users(value: AppThreeFieldUsers[]) {
    this._users = value;
  }
  public resetUsers() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      users: cdktf.listMapper(appThreeFieldUsersToTerraform)(this._users),
    };
  }
}
