...
// https://registry.terraform.io/providers/okta/okta/4.18.0/docs/resources/admin_role_custom
...
export class AdminRoleCustom extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminRoleCustom that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.18.0/docs/resources/admin_role_custom#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.18.0/docs/resources/admin_role_custom okta_admin_role_custom} Resource
  *
  * @param scope The scope in which to define this construct
