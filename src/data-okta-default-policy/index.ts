...
// https://registry.terraform.io/providers/okta/okta/4.18.0/docs/data-sources/default_policy
...
export class DataOktaDefaultPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaDefaultPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.18.0/docs/data-sources/default_policy#import import section} in the documentation of this resource for the id to use
