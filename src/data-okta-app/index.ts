// https://registry.terraform.io/providers/okta/okta/4.16.0/docs/data-sources/app
...
export class DataOktaApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/data-sources/app#import import section} in the documentation of this resource for the id to use
