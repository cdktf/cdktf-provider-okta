...
// https://registry.terraform.io/providers/okta/okta/4.17.0/docs/data-sources/user_security_questions
...
export class DataOktaUserSecurityQuestions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaUserSecurityQuestions that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.17.0/docs/data-sources/user_security_questions#import import section} in the documentation of this resource for the id to use
