// https://registry.terraform.io/providers/okta/okta/4.8.0/docs/resources/app_three_field
...
export class AppThreeField extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppThreeField that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.0/docs/resources/app_three_field#import import section} in the documentation of this resource for the id to use
