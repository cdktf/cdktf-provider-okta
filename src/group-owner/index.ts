...
// https://registry.terraform.io/providers/okta/okta/4.19.0/docs/resources/group_owner
...
export class GroupOwner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupOwner that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.19.0/docs/resources/group_owner#import import section} in the documentation of this resource for the id to use
