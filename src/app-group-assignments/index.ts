// https://registry.terraform.io/providers/okta/okta/4.6.1/docs/resources/app_group_assignments
...
export class AppGroupAssignments extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppGroupAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.1/docs/resources/app_group_assignments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.6.1/docs/resources/app_group_assignments okta_app_group_assignments} Resource
  *
  * @param scope The scope in which to define this construct
