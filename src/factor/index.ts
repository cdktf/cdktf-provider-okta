...
// https://registry.terraform.io/providers/okta/okta/4.6.3/docs/resources/factor
...
export class Factor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Factor that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.3/docs/resources/factor#import import section} in the documentation of this resource for the id to use
