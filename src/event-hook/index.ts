// https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/event_hook
...
export class EventHook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventHook that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/event_hook#import import section} in the documentation of this resource for the id to use
