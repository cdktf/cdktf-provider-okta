// https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/app_user_schema_property
...
export class AppUserSchemaProperty extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppUserSchemaProperty that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/app_user_schema_property#import import section} in the documentation of this resource for the id to use
