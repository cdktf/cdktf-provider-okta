...
export class PolicyRuleSignon extends cdktf.TerraformResource {
  ...
  */
  ...
  private _factorSequence?: PolicyRuleSignonFactorSequence[] | cdktf.IResolvable; 
  public get factorSequence() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('factor_sequence');
  }
  public set factorSequence(value: PolicyRuleSignonFactorSequence[] | cdktf.IResolvable) {
