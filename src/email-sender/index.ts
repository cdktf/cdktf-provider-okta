...
// https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/email_sender
...
export class EmailSender extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailSender that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/email_sender#import import section} in the documentation of this resource for the id to use
