// https://registry.terraform.io/providers/okta/okta/4.5.0/docs/data-sources/groups
...
export class DataOktaGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.5.0/docs/data-sources/groups#import import section} in the documentation of this resource for the id to use
