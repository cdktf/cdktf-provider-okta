// https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/theme
...
export class Theme extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Theme that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/theme#import import section} in the documentation of this resource for the id to use
