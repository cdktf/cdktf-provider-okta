// https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/captcha
...
export class Captcha extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Captcha that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/captcha#import import section} in the documentation of this resource for the id to use
