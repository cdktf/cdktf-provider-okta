// https://registry.terraform.io/providers/okta/okta/4.18.0/docs/data-sources/auth_server_claims
...
export class DataOktaAuthServerClaims extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAuthServerClaims that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.18.0/docs/data-sources/auth_server_claims#import import section} in the documentation of this resource for the id to use
