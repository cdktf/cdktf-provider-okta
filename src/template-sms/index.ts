...
// https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/template_sms
...
export class TemplateSms extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TemplateSms that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/template_sms#import import section} in the documentation of this resource for the id to use
