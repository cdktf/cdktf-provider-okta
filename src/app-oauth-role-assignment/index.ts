...
// https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/app_oauth_role_assignment
...
export class AppOauthRoleAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppOauthRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/app_oauth_role_assignment#import import section} in the documentation of this resource for the id to use
