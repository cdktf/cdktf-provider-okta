...
// https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/rate_limiting
...
export class RateLimiting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RateLimiting that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/rate_limiting#import import section} in the documentation of this resource for the id to use
