// https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/app_signon_policy_rule
...
export class AppSignonPolicyRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppSignonPolicyRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/app_signon_policy_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/app_signon_policy_rule okta_app_signon_policy_rule} Resource
  *
  * @param scope The scope in which to define this construct
