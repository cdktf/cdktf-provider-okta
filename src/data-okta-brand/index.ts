// https://registry.terraform.io/providers/okta/okta/4.8.0/docs/data-sources/brand
...
export class DataOktaBrand extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaBrand that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.0/docs/data-sources/brand#import import section} in the documentation of this resource for the id to use
