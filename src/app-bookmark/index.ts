...
// https://registry.terraform.io/providers/okta/okta/4.19.0/docs/resources/app_bookmark
...
export class AppBookmark extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppBookmark that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.19.0/docs/resources/app_bookmark#import import section} in the documentation of this resource for the id to use
