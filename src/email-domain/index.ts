// https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/email_domain
...
export class EmailDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/email_domain#import import section} in the documentation of this resource for the id to use
