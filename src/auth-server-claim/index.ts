...
// https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/auth_server_claim
...
export class AuthServerClaim extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthServerClaim that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/auth_server_claim#import import section} in the documentation of this resource for the id to use
