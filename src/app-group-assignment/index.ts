// https://registry.terraform.io/providers/okta/okta/4.12.0/docs/resources/app_group_assignment
...
export class AppGroupAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppGroupAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.12.0/docs/resources/app_group_assignment#import import section} in the documentation of this resource for the id to use
