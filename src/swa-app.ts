// https://www.terraform.io/docs/providers/okta/r/swa_app.html
...
export function swaAppUsersToTerraform(struct?: SwaAppUsers): any {
...
export class SwaApp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "okta_swa_app";
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/okta/r/swa_app.html okta_swa_app} Resource
  *
  ...
  */
  ...
  private _users?: SwaAppUsers[]; 
  public get users() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('users') as any;
  }
  public set users(value: SwaAppUsers[]) {
    this._users = value;
  }
  public resetUsers() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      users: cdktf.listMapper(swaAppUsersToTerraform)(this._users),
    };
  }
}
