// https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/policy_mfa
...
export class PolicyMfa extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyMfa that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/policy_mfa#import import section} in the documentation of this resource for the id to use
