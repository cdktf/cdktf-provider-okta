...
// https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/idp_oidc
...
export class DataOktaIdpOidc extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaIdpOidc that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/idp_oidc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/idp_oidc okta_idp_oidc} Data Source
  *
  * @param scope The scope in which to define this construct
