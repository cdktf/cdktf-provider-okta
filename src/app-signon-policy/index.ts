// https://registry.terraform.io/providers/okta/okta/4.13.1/docs/resources/app_signon_policy
...
export class AppSignonPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppSignonPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.13.1/docs/resources/app_signon_policy#import import section} in the documentation of this resource for the id to use
