// https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/org_support
...
export class OrgSupport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgSupport that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/org_support#import import section} in the documentation of this resource for the id to use
