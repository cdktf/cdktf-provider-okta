// https://registry.terraform.io/providers/okta/okta/4.12.0/docs/data-sources/behavior
...
export class DataOktaBehavior extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaBehavior that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.12.0/docs/data-sources/behavior#import import section} in the documentation of this resource for the id to use
