// https://registry.terraform.io/providers/okta/okta/4.5.0/docs/data-sources/app_group_assignments
...
export class DataOktaAppGroupAssignments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppGroupAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.5.0/docs/data-sources/app_group_assignments#import import section} in the documentation of this resource for the id to use
