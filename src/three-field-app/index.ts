// https://registry.terraform.io/providers/okta/okta/3.46.0/docs/resources/three_field_app
...
export interface ThreeFieldAppConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly timeouts?: ThreeFieldAppTimeouts;
  /**
  * users block
  * 
...
export interface ThreeFieldAppTimeouts {
  /**
...
export function threeFieldAppTimeoutsToTerraform(struct?: ThreeFieldAppTimeouts | cdktf.IResolvable): any {
...
export class ThreeFieldAppTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ThreeFieldAppTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ThreeFieldAppTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ThreeFieldApp extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ThreeFieldAppTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ThreeFieldAppTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: threeFieldAppTimeoutsToTerraform(this._timeouts.internalValue),
