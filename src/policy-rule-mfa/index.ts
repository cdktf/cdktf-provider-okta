...
// https://registry.terraform.io/providers/okta/okta/4.6.3/docs/resources/policy_rule_mfa
...
export class PolicyRuleMfa extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyRuleMfa that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.3/docs/resources/policy_rule_mfa#import import section} in the documentation of this resource for the id to use
