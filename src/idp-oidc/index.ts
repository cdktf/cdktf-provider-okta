...
// https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/idp_oidc
...
export class IdpOidc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdpOidc that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/idp_oidc#import import section} in the documentation of this resource for the id to use
