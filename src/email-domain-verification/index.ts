// https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/email_domain_verification
...
export class EmailDomainVerification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailDomainVerification that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/email_domain_verification#import import section} in the documentation of this resource for the id to use
