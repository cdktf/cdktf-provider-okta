...
// https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/link_value
...
export class LinkValue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinkValue that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/link_value#import import section} in the documentation of this resource for the id to use
