...
// https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/trusted_origin
...
export class TrustedOrigin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrustedOrigin that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/trusted_origin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/trusted_origin okta_trusted_origin} Resource
  *
  * @param scope The scope in which to define this construct
