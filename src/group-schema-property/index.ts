// https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/group_schema_property
...
export class GroupSchemaProperty extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupSchemaProperty that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/group_schema_property#import import section} in the documentation of this resource for the id to use
