// https://www.terraform.io/docs/providers/okta/r/app_shared_credentials
...
export interface AppSharedCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly users?: AppSharedCredentialsUsers[] | cdktf.IResolvable;
}
...
export function appSharedCredentialsTimeoutsToTerraform(struct?: AppSharedCredentialsTimeoutsOutputReference | AppSharedCredentialsTimeouts | cdktf.IResolvable): any {
...
export function appSharedCredentialsUsersToTerraform(struct?: AppSharedCredentialsUsers | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      users: cdktf.listMapper(appSharedCredentialsUsersToTerraform, true)(this._users.internalValue),
    };
  }
}
