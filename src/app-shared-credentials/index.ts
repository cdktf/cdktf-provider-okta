// https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/app_shared_credentials
...
export class AppSharedCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppSharedCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/app_shared_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/app_shared_credentials okta_app_shared_credentials} Resource
  *
  * @param scope The scope in which to define this construct
