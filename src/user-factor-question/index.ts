...
// https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/user_factor_question
...
export class UserFactorQuestion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserFactorQuestion that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/user_factor_question#import import section} in the documentation of this resource for the id to use
