...
// https://registry.terraform.io/providers/okta/okta/4.5.0/docs/resources/event_hook_verification
...
export class EventHookVerification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventHookVerification that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.5.0/docs/resources/event_hook_verification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.5.0/docs/resources/event_hook_verification okta_event_hook_verification} Resource
  *
  * @param scope The scope in which to define this construct
