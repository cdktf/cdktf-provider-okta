// https://www.terraform.io/docs/providers/okta/r/app_secure_password_store.html
...
export interface AppSecurePasswordStoreConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly users?: AppSecurePasswordStoreUsers[];
}
...
export function appSecurePasswordStoreUsersToTerraform(struct?: AppSecurePasswordStoreUsers): any {
...
export class AppSecurePasswordStore extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/okta/r/app_secure_password_store.html okta_app_secure_password_store} Resource
  *
  ...
  */
  ...
  private _users?: AppSecurePasswordStoreUsers[]; 
  public get users() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('users') as any;
  }
  public set users(value: AppSecurePasswordStoreUsers[]) {
    this._users = value;
  }
  public resetUsers() {
