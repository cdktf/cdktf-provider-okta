...
// https://registry.terraform.io/providers/okta/okta/4.8.1/docs/data-sources/trusted_origins
...
export class DataOktaTrustedOrigins extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaTrustedOrigins that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/data-sources/trusted_origins#import import section} in the documentation of this resource for the id to use
