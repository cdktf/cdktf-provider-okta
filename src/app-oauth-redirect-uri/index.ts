...
// https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/app_oauth_redirect_uri
...
export class AppOauthRedirectUri extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppOauthRedirectUri that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/app_oauth_redirect_uri#import import section} in the documentation of this resource for the id to use
