...
// https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/idp_social
...
export class IdpSocial extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdpSocial that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/idp_social#import import section} in the documentation of this resource for the id to use
