...
// https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/app_user
...
export class AppUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/app_user#import import section} in the documentation of this resource for the id to use
