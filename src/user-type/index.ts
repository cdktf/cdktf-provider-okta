...
// https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/user_type
...
export class UserType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserType that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/user_type#import import section} in the documentation of this resource for the id to use
