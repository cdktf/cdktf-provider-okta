...
// https://registry.terraform.io/providers/okta/okta/4.7.0/docs/data-sources/email_customizations
...
export class DataOktaEmailCustomizations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaEmailCustomizations that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.7.0/docs/data-sources/email_customizations#import import section} in the documentation of this resource for the id to use
