...
// https://registry.terraform.io/providers/okta/okta/4.13.1/docs/data-sources/email_customizations
...
export class DataOktaEmailCustomizations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaEmailCustomizations that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.13.1/docs/data-sources/email_customizations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.13.1/docs/data-sources/email_customizations okta_email_customizations} Data Source
  *
  * @param scope The scope in which to define this construct
