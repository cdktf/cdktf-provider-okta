// https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/inline_hook
...
export class InlineHook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InlineHook that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/inline_hook#import import section} in the documentation of this resource for the id to use
