...
// https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/policy_password_default
...
export class PolicyPasswordDefault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyPasswordDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/policy_password_default#import import section} in the documentation of this resource for the id to use
