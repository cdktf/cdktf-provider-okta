...
// https://registry.terraform.io/providers/okta/okta/4.13.1/docs/resources/policy_password_default
...
export class PolicyPasswordDefault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyPasswordDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.13.1/docs/resources/policy_password_default#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.13.1/docs/resources/policy_password_default okta_policy_password_default} Resource
  *
  * @param scope The scope in which to define this construct
