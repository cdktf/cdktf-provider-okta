// https://registry.terraform.io/providers/okta/okta/4.13.1/docs/data-sources/themes
...
export class DataOktaThemes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaThemes that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.13.1/docs/data-sources/themes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.13.1/docs/data-sources/themes okta_themes} Data Source
  *
  * @param scope The scope in which to define this construct
