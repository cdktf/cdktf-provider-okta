...
// https://registry.terraform.io/providers/okta/okta/4.9.1/docs/data-sources/app_oauth
...
export class DataOktaAppOauth extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppOauth that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/data-sources/app_oauth#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/data-sources/app_oauth okta_app_oauth} Data Source
  *
  * @param scope The scope in which to define this construct
