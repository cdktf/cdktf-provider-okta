...
// https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/policy_profile_enrollment_apps
...
export class PolicyProfileEnrollmentApps extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyProfileEnrollmentApps that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/policy_profile_enrollment_apps#import import section} in the documentation of this resource for the id to use
