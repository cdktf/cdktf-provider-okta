...
// https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/policy_profile_enrollment_apps
...
export class PolicyProfileEnrollmentApps extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyProfileEnrollmentApps that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/policy_profile_enrollment_apps#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/policy_profile_enrollment_apps okta_policy_profile_enrollment_apps} Resource
  *
  * @param scope The scope in which to define this construct
