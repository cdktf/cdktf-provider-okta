...
// https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/resource_set
...
export class ResourceSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourceSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/resource_set#import import section} in the documentation of this resource for the id to use
