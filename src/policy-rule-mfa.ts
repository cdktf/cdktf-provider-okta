  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      app_exclude: cdktf.listMapper(policyRuleMfaAppExcludeToTerraform)(this._appExclude.internalValue),
      app_include: cdktf.listMapper(policyRuleMfaAppIncludeToTerraform)(this._appInclude.internalValue),
    };
  }
}
