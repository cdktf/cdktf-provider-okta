// https://registry.terraform.io/providers/okta/okta/4.6.3/docs/data-sources/everyone_group
...
export class DataOktaEveryoneGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaEveryoneGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.3/docs/data-sources/everyone_group#import import section} in the documentation of this resource for the id to use
