// https://registry.terraform.io/providers/okta/okta/3.46.0/docs/resources/app_secure_password_store
...
export class AppSecurePasswordStoreUsersOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): AppSecurePasswordStoreUsers | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: AppSecurePasswordStoreUsers | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._id = undefined;
...
export class AppSecurePasswordStoreUsersList extends cdktf.ComplexList {
  public internalValue? : AppSecurePasswordStoreUsers[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AppSecurePasswordStoreUsersOutputReference {
    return new AppSecurePasswordStoreUsersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class AppSecurePasswordStore extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/3.46.0/docs/resources/app_secure_password_store okta_app_secure_password_store} Resource
  *
  ...
  */
  ...
  private _users = new AppSecurePasswordStoreUsersList(this, "users", true);
  public get users() {
    return this._users;
  }
  public putUsers(value: AppSecurePasswordStoreUsers[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      users: cdktf.listMapper(appSecurePasswordStoreUsersToTerraform, true)(this._users.internalValue),
    };
  }
}
