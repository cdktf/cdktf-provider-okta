...
// https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/behavior
...
export class Behavior extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Behavior that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/behavior#import import section} in the documentation of this resource for the id to use
