// https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/user_admin_roles
...
export class UserAdminRoles extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserAdminRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/user_admin_roles#import import section} in the documentation of this resource for the id to use
