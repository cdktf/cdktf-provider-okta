// https://registry.terraform.io/providers/okta/okta/4.9.1/docs/resources/idp_saml
...
export class IdpSaml extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdpSaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/resources/idp_saml#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/resources/idp_saml okta_idp_saml} Resource
  *
  * @param scope The scope in which to define this construct
