...
// https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/apps
...
export class DataOktaApps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaApps that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/apps#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/apps okta_apps} Data Source
  *
  * @param scope The scope in which to define this construct
