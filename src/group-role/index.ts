// https://registry.terraform.io/providers/okta/okta/4.8.0/docs/resources/group_role
...
export class GroupRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.0/docs/resources/group_role#import import section} in the documentation of this resource for the id to use
