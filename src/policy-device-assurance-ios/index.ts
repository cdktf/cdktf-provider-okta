// https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/policy_device_assurance_ios
...
export class PolicyDeviceAssuranceIos extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyDeviceAssuranceIos that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/policy_device_assurance_ios#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/policy_device_assurance_ios okta_policy_device_assurance_ios} Resource
  *
  * @param scope The scope in which to define this construct
