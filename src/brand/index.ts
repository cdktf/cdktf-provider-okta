...
// https://registry.terraform.io/providers/okta/okta/4.17.0/docs/resources/brand
...
export class Brand extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Brand that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.17.0/docs/resources/brand#import import section} in the documentation of this resource for the id to use
