// https://registry.terraform.io/providers/okta/okta/3.46.0/docs/resources/bookmark_app
...
export interface BookmarkAppConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly timeouts?: BookmarkAppTimeouts;
  /**
  * users block
  * 
  ...
  */
  readonly users?: BookmarkAppUsers[] | cdktf.IResolvable;
}
export interface BookmarkAppTimeouts {
  /**
...
export function bookmarkAppTimeoutsToTerraform(struct?: BookmarkAppTimeouts | cdktf.IResolvable): any {
...
export class BookmarkAppTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BookmarkAppTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: BookmarkAppTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export function bookmarkAppUsersToTerraform(struct?: BookmarkAppUsers | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class BookmarkAppUsersOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): BookmarkAppUsers | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: BookmarkAppUsers | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._id = undefined;
...
export class BookmarkAppUsersList extends cdktf.ComplexList {
  public internalValue? : BookmarkAppUsers[] | cdktf.IResolvable
  ...
  */
  public get(index: number): BookmarkAppUsersOutputReference {
    return new BookmarkAppUsersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class BookmarkApp extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "okta_bookmark_app";
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/3.46.0/docs/resources/bookmark_app okta_bookmark_app} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options BookmarkAppConfig
  */
  public constructor(scope: Construct, id: string, config: BookmarkAppConfig) {
    super(scope, id, {
  ...
  private _timeouts = new BookmarkAppTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
  ...
  private _users = new BookmarkAppUsersList(this, "users", true);
  public get users() {
    return this._users;
  }
  public putUsers(value: BookmarkAppUsers[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: bookmarkAppTimeoutsToTerraform(this._timeouts.internalValue),
      users: cdktf.listMapper(bookmarkAppUsersToTerraform, true)(this._users.internalValue),
    };
  }
}
