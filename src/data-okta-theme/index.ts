...
// https://registry.terraform.io/providers/okta/okta/4.4.3/docs/data-sources/theme
...
export class DataOktaTheme extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaTheme that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/data-sources/theme#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/data-sources/theme okta_theme} Data Source
  *
  * @param scope The scope in which to define this construct
