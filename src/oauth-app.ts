...
export function oauthAppGroupsClaimToTerraform(struct?: OauthAppGroupsClaimOutputReference | OauthAppGroupsClaim | cdktf.IResolvable): any {
...
export class OauthApp extends cdktf.TerraformResource {
  ...
  */
  ...
  private _groupsClaim = new OauthAppGroupsClaimOutputReference(this, "groups_claim", true);
