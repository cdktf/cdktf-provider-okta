...
// https://registry.terraform.io/providers/okta/okta/4.12.0/docs/data-sources/idp_social
...
export class DataOktaIdpSocial extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaIdpSocial that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.12.0/docs/data-sources/idp_social#import import section} in the documentation of this resource for the id to use
