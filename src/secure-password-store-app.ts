...
export function securePasswordStoreAppUsersToTerraform(struct?: SecurePasswordStoreAppUsers): any {
...
export class SecurePasswordStoreApp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "okta_secure_password_store_app";
  ...
  */
  ...
  private _users?: SecurePasswordStoreAppUsers[]; 
  public get users() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('users') as any;
  }
  public set users(value: SecurePasswordStoreAppUsers[]) {
    this._users = value;
  }
  public resetUsers() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      users: cdktf.listMapper(securePasswordStoreAppUsersToTerraform)(this._users),
    };
  }
}
