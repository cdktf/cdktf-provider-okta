// https://registry.terraform.io/providers/okta/okta/4.6.1/docs/data-sources/policy
...
export class DataOktaPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.1/docs/data-sources/policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.6.1/docs/data-sources/policy okta_policy} Data Source
  *
  * @param scope The scope in which to define this construct
