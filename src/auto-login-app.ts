...
export function autoLoginAppTimeoutsToTerraform(struct?: AutoLoginAppTimeoutsOutputReference | AutoLoginAppTimeouts | cdktf.IResolvable): any {
...
export class AutoLoginAppTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AutoLoginAppTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AutoLoginAppTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AutoLoginApp extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AutoLoginAppTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: autoLoginAppTimeoutsToTerraform(this._timeouts.internalValue),
      users: cdktf.listMapper(autoLoginAppUsersToTerraform, true)(this._users.internalValue),
    };
  }
}
