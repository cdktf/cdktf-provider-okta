// https://registry.terraform.io/providers/okta/okta/4.14.0/docs/data-sources/default_signin_page
...
export class DataOktaDefaultSigninPage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaDefaultSigninPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/data-sources/default_signin_page#import import section} in the documentation of this resource for the id to use
