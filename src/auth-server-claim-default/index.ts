...
// https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/auth_server_claim_default
...
export class AuthServerClaimDefault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthServerClaimDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/auth_server_claim_default#import import section} in the documentation of this resource for the id to use
