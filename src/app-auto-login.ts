...
export function appAutoLoginUsersToTerraform(struct?: AppAutoLoginUsers): any {
...
export class AppAutoLogin extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "okta_app_auto_login";
  ...
  */
  ...
  private _users?: AppAutoLoginUsers[]; 
  public get users() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('users') as any;
  }
  public set users(value: AppAutoLoginUsers[]) {
    this._users = value;
  }
  public resetUsers() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      users: cdktf.listMapper(appAutoLoginUsersToTerraform)(this._users),
    };
  }
}
