// https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/app_swa
...
export class AppSwa extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppSwa that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/app_swa#import import section} in the documentation of this resource for the id to use
