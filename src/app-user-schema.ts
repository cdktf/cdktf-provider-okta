...
export class AppUserSchemaArrayOneOfOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AppUserSchemaArrayOneOf | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AppUserSchemaArrayOneOf | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AppUserSchemaArrayOneOfList extends cdktf.ComplexList {
  public internalValue? : AppUserSchemaArrayOneOf[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AppUserSchemaArrayOneOfOutputReference {
    return new AppUserSchemaArrayOneOfOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class AppUserSchemaOneOfOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): AppUserSchemaOneOf | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: AppUserSchemaOneOf | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._const = undefined;
...
export class AppUserSchemaOneOfList extends cdktf.ComplexList {
  public internalValue? : AppUserSchemaOneOf[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AppUserSchemaOneOfOutputReference {
    return new AppUserSchemaOneOfOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class AppUserSchema extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "okta_app_user_schema";
  ...
  */
  public constructor(scope: Construct, id: string, config: AppUserSchemaConfig) {
    super(scope, id, {
      terraformResourceType: 'okta_app_user_schema',
  ...
  private _arrayOneOf = new AppUserSchemaArrayOneOfList(this, "array_one_of", false);
  public get arrayOneOf() {
    return this._arrayOneOf;
  }
  public putArrayOneOf(value: AppUserSchemaArrayOneOf[] | cdktf.IResolvable) {
  ...
  private _oneOf = new AppUserSchemaOneOfList(this, "one_of", false);
  public get oneOf() {
    return this._oneOf;
  }
  public putOneOf(value: AppUserSchemaOneOf[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      array_one_of: cdktf.listMapper(appUserSchemaArrayOneOfToTerraform, true)(this._arrayOneOf.internalValue),
      one_of: cdktf.listMapper(appUserSchemaOneOfToTerraform, true)(this._oneOf.internalValue),
    };
  }
}
