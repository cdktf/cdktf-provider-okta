...
export class AppUserSchema extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "okta_app_user_schema";
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      array_one_of: cdktf.listMapper(appUserSchemaArrayOneOfToTerraform)(this._arrayOneOf),
      one_of: cdktf.listMapper(appUserSchemaOneOfToTerraform)(this._oneOf),
    };
  }
}
