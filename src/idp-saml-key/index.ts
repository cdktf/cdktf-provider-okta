// https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/idp_saml_key
...
export class IdpSamlKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdpSamlKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/idp_saml_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/idp_saml_key okta_idp_saml_key} Resource
  *
  * @param scope The scope in which to define this construct
