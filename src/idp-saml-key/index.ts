// https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/idp_saml_key
...
export class IdpSamlKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdpSamlKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/idp_saml_key#import import section} in the documentation of this resource for the id to use
