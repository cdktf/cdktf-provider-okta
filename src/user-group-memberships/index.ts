...
// https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/user_group_memberships
...
export class UserGroupMemberships extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGroupMemberships that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/user_group_memberships#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/user_group_memberships okta_user_group_memberships} Resource
  *
  * @param scope The scope in which to define this construct
