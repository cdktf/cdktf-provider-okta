...
// https://registry.terraform.io/providers/okta/okta/4.18.0/docs/data-sources/device_assurance_policy
...
export class DataOktaDeviceAssurancePolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaDeviceAssurancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.18.0/docs/data-sources/device_assurance_policy#import import section} in the documentation of this resource for the id to use
