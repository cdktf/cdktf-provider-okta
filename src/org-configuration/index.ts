...
// https://registry.terraform.io/providers/okta/okta/4.6.1/docs/resources/org_configuration
...
export class OrgConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.1/docs/resources/org_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.6.1/docs/resources/org_configuration okta_org_configuration} Resource
  *
  * @param scope The scope in which to define this construct
