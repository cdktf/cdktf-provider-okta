...
// https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/authenticator
...
export class Authenticator extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Authenticator that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/authenticator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/authenticator okta_authenticator} Resource
  *
  * @param scope The scope in which to define this construct
