...
// https://registry.terraform.io/providers/okta/okta/4.19.0/docs/data-sources/log_stream
...
export class DataOktaLogStream extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaLogStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.19.0/docs/data-sources/log_stream#import import section} in the documentation of this resource for the id to use
