...
// https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/app_auto_login
...
export class AppAutoLogin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppAutoLogin that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/app_auto_login#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.14.1/docs/resources/app_auto_login okta_app_auto_login} Resource
  *
  * @param scope The scope in which to define this construct
