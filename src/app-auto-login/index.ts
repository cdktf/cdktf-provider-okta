// https://registry.terraform.io/providers/okta/okta/3.46.0/docs/resources/app_auto_login
...
export function appAutoLoginUsersToTerraform(struct?: AppAutoLoginUsers | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AppAutoLoginUsersOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): AppAutoLoginUsers | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: AppAutoLoginUsers | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._id = undefined;
...
export class AppAutoLoginUsersList extends cdktf.ComplexList {
  public internalValue? : AppAutoLoginUsers[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AppAutoLoginUsersOutputReference {
    return new AppAutoLoginUsersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class AppAutoLogin extends cdktf.TerraformResource {
  ...
  */
  ...
  public putUsers(value: AppAutoLoginUsers[] | cdktf.IResolvable) {
