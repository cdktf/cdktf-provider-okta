...
// https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/user_type
...
export class DataOktaUserType extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaUserType that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.13.0/docs/data-sources/user_type#import import section} in the documentation of this resource for the id to use
