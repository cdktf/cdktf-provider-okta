// https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/factor_totp
...
export class FactorTotp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FactorTotp that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/factor_totp#import import section} in the documentation of this resource for the id to use
