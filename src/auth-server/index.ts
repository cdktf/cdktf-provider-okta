...
// https://registry.terraform.io/providers/okta/okta/4.9.1/docs/resources/auth_server
...
export class AuthServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/resources/auth_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/resources/auth_server okta_auth_server} Resource
  *
  * @param scope The scope in which to define this construct
