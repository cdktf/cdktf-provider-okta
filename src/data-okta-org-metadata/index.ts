...
// https://registry.terraform.io/providers/okta/okta/4.12.0/docs/data-sources/org_metadata
...
export class DataOktaOrgMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaOrgMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.12.0/docs/data-sources/org_metadata#import import section} in the documentation of this resource for the id to use
