// https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/policy_signon
...
export class PolicySignon extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicySignon that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/policy_signon#import import section} in the documentation of this resource for the id to use
