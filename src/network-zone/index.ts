// https://registry.terraform.io/providers/okta/okta/4.19.0/docs/resources/network_zone
...
export class NetworkZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.19.0/docs/resources/network_zone#import import section} in the documentation of this resource for the id to use
