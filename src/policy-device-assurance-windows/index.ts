...
// https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/policy_device_assurance_windows
...
export class PolicyDeviceAssuranceWindows extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyDeviceAssuranceWindows that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/policy_device_assurance_windows#import import section} in the documentation of this resource for the id to use
