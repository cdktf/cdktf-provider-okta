// https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/policy_profile_enrollment
...
export class PolicyProfileEnrollment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyProfileEnrollment that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/policy_profile_enrollment#import import section} in the documentation of this resource for the id to use
