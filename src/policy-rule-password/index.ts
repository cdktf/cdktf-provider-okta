// https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/policy_rule_password
...
export class PolicyRulePassword extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyRulePassword that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/policy_rule_password#import import section} in the documentation of this resource for the id to use
