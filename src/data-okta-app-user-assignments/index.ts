...
// https://registry.terraform.io/providers/okta/okta/4.11.1/docs/data-sources/app_user_assignments
...
export class DataOktaAppUserAssignments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppUserAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/data-sources/app_user_assignments#import import section} in the documentation of this resource for the id to use
