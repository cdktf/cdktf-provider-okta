...
// https://registry.terraform.io/providers/okta/okta/4.9.1/docs/data-sources/app_user_assignments
...
export class DataOktaAppUserAssignments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppUserAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/data-sources/app_user_assignments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/4.9.1/docs/data-sources/app_user_assignments okta_app_user_assignments} Data Source
  *
  * @param scope The scope in which to define this construct
