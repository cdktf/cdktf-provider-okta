  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      attribute_statements: cdktf.listMapper(appSamlAttributeStatementsToTerraform)(this._attributeStatements.internalValue),
      users: cdktf.listMapper(appSamlUsersToTerraform)(this._users.internalValue),
    };
  }
}
