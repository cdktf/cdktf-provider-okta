...
// https://registry.terraform.io/providers/okta/okta/4.6.2/docs/data-sources/idp_metadata_saml
...
export class DataOktaIdpMetadataSaml extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaIdpMetadataSaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.2/docs/data-sources/idp_metadata_saml#import import section} in the documentation of this resource for the id to use
