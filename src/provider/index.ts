...
// https://registry.terraform.io/providers/okta/okta/4.17.0/docs
...
export class OktaProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing OktaProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.17.0/docs#import import section} in the documentation of this resource for the id to use
