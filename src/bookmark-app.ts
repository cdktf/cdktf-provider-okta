// https://www.terraform.io/docs/providers/okta/r/bookmark_app.html
...
export function bookmarkAppUsersToTerraform(struct?: BookmarkAppUsers): any {
...
export class BookmarkApp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "okta_bookmark_app";
  ...
  */
  ...
  public get requestIntegration() {
    return this.getBooleanAttribute('request_integration') as any;
  }
  ...
  private _users?: BookmarkAppUsers[]; 
  public get users() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('users') as any;
  }
  public set users(value: BookmarkAppUsers[]) {
    this._users = value;
  }
  public resetUsers() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      users: cdktf.listMapper(bookmarkAppUsersToTerraform)(this._users),
    };
  }
}
