// https://registry.terraform.io/providers/okta/okta/4.12.0/docs/resources/user_base_schema_property
...
export class UserBaseSchemaProperty extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserBaseSchemaProperty that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.12.0/docs/resources/user_base_schema_property#import import section} in the documentation of this resource for the id to use
