// https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/admin_role_custom_assignments
...
export class AdminRoleCustomAssignments extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminRoleCustomAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.14.0/docs/resources/admin_role_custom_assignments#import import section} in the documentation of this resource for the id to use
