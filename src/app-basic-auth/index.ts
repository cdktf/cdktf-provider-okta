// https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/app_basic_auth
...
export class AppBasicAuth extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppBasicAuth that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.15.0/docs/resources/app_basic_auth#import import section} in the documentation of this resource for the id to use
