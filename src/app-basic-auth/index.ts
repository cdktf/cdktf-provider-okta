// https://www.terraform.io/docs/providers/okta/r/app_basic_auth
...
export interface AppBasicAuthConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly users?: AppBasicAuthUsers[] | cdktf.IResolvable;
}
...
export function appBasicAuthTimeoutsToTerraform(struct?: AppBasicAuthTimeoutsOutputReference | AppBasicAuthTimeouts | cdktf.IResolvable): any {
...
export interface AppBasicAuthUsers {
  /**
  * User ID.
  * 
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/r/app_basic_auth#id AppBasicAuth#id}
...
export function appBasicAuthUsersToTerraform(struct?: AppBasicAuthUsers | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AppBasicAuthUsersOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): AppBasicAuthUsers | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: AppBasicAuthUsers | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._id = undefined;
...
export class AppBasicAuthUsersList extends cdktf.ComplexList {
  public internalValue? : AppBasicAuthUsers[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AppBasicAuthUsersOutputReference {
    return new AppBasicAuthUsersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class AppBasicAuth extends cdktf.TerraformResource {
  ...
  */
  ...
  private _users = new AppBasicAuthUsersList(this, "users", true);
  public get users() {
    return this._users;
  }
  public putUsers(value: AppBasicAuthUsers[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      users: cdktf.listMapper(appBasicAuthUsersToTerraform, true)(this._users.internalValue),
    };
  }
}
