// https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/group_memberships
...
export class GroupMemberships extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupMemberships that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/group_memberships#import import section} in the documentation of this resource for the id to use
