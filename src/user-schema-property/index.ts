...
// https://registry.terraform.io/providers/okta/okta/4.19.0/docs/resources/user_schema_property
...
export class UserSchemaProperty extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserSchemaProperty that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.19.0/docs/resources/user_schema_property#import import section} in the documentation of this resource for the id to use
