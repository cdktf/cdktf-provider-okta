// https://registry.terraform.io/providers/okta/okta/4.13.1/docs/resources/policy_device_assurance_macos
...
export class PolicyDeviceAssuranceMacos extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyDeviceAssuranceMacos that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.13.1/docs/resources/policy_device_assurance_macos#import import section} in the documentation of this resource for the id to use
