...
// https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/app_oauth
...
export class AppOauth extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppOauth that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/app_oauth#import import section} in the documentation of this resource for the id to use
