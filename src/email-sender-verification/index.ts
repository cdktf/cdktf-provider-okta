// https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/email_sender_verification
...
export class EmailSenderVerification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailSenderVerification that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.6.0/docs/resources/email_sender_verification#import import section} in the documentation of this resource for the id to use
