...
// https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/email_customization
...
export class EmailCustomization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailCustomization that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.7.0/docs/resources/email_customization#import import section} in the documentation of this resource for the id to use
