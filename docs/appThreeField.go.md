...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v11/appthreefield"
...
&appthreefield.AppThreeFieldConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v11.appThreeField.AppThreeFieldTimeouts,
	UrlRegex: *string,
