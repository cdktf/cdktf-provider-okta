...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v9/appthreefield"
...
&appthreefield.AppThreeFieldConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v9.appThreeField.AppThreeFieldTimeouts,
	UrlRegex: *string,
