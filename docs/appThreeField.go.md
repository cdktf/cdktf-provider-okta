...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v6/appthreefield"
...
&appthreefield.AppThreeFieldConfig {
	...
	SkipUsers: interface{},
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v6.appThreeField.AppThreeFieldTimeouts,
	UrlRegex: *string,
