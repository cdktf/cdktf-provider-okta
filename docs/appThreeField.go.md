...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/appthreefield"
...
&appthreefield.AppThreeFieldConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v10.appThreeField.AppThreeFieldTimeouts,
	UrlRegex: *string,
