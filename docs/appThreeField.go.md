...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/appthreefield"
...
&appthreefield.AppThreeFieldConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v8.appThreeField.AppThreeFieldTimeouts,
	UrlRegex: *string,
