...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v14/appthreefield"
...
&appthreefield.AppThreeFieldConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v14.appThreeField.AppThreeFieldTimeouts,
	UrlRegex: *string,
