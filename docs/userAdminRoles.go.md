...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/useradminroles"
...
| <code><a href="#@cdktf/provider-okta.userAdminRoles.UserAdminRolesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.0/docs/resources/user_admin_roles#id UserAdminRoles#id}. |
