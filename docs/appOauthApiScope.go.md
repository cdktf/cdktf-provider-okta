...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v9/appoauthapiscope"
...
| <code><a href="#@cdktf/provider-okta.appOauthApiScope.AppOauthApiScopeConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/resources/app_oauth_api_scope#id AppOauthApiScope#id}. |
