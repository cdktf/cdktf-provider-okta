...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/rolesubscription"
...
| <code><a href="#@cdktf/provider-okta.roleSubscription.RoleSubscriptionConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.0/docs/resources/role_subscription#id RoleSubscription#id}. |
