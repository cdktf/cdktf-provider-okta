...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/trustedorigin"
...
| <code><a href="#@cdktf/provider-okta.trustedOrigin.TrustedOriginConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.0/docs/resources/trusted_origin#id TrustedOrigin#id}. |
