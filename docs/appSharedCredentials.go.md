...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/appsharedcredentials"
...
&appsharedcredentials.AppSharedCredentialsConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v10.appSharedCredentials.AppSharedCredentialsTimeouts,
	Url: *string,
	UrlRegex: *string,
