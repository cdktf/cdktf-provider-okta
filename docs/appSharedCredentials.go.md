...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/appsharedcredentials"
...
&appsharedcredentials.AppSharedCredentialsConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v8.appSharedCredentials.AppSharedCredentialsTimeouts,
	Url: *string,
	UrlRegex: *string,
