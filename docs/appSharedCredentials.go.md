...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v5/appsharedcredentials"
...
&appsharedcredentials.AppSharedCredentialsConfig {
	...
	SkipUsers: interface{},
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v5.appSharedCredentials.AppSharedCredentialsTimeouts,
	Url: *string,
	UrlRegex: *string,
