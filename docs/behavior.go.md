...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v14/behavior"
...
| <code><a href="#@cdktf/provider-okta.behavior.BehaviorConfig.property.velocity">Velocity</a></code> | <code>*f64</code> | Velocity (in kilometers per hour). Should be at least 1. Required for `VELOCITY` behavior. |
