...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v14/policydeviceassurancechromeos"
...
Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.19.0/docs/resources/policy_device_assurance_chromeos#import import section} in the documentation of this resource for the id to use
