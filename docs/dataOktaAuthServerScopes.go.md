...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/dataoktaauthserverscopes"
...
| <code><a href="#@cdktf/provider-okta.dataOktaAuthServerScopes.DataOktaAuthServerScopesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/auth_server_scopes#id DataOktaAuthServerScopes#id}. |
