...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v7/autologinapp"
...
&autologinapp.AutoLoginAppConfig {
	...
	SkipUsers: interface{},
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v7.autoLoginApp.AutoLoginAppTimeouts,
