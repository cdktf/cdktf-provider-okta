...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/appbasicauth"
...
&appbasicauth.AppBasicAuthConfig {
	...
	Logo: *string,
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v10.appBasicAuth.AppBasicAuthTimeouts,
}
```
