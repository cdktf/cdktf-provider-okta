...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v9/appbasicauth"
...
&appbasicauth.AppBasicAuthConfig {
	...
	Logo: *string,
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v9.appBasicAuth.AppBasicAuthTimeouts,
}
```
