...
Refer to the Terraform Registory for docs: [`data_okta_app_user_assignments`](https://registry.terraform.io/providers/okta/okta/4.4.1/docs/data-sources/app_user_assignments).
