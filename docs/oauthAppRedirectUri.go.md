...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v7/oauthappredirecturi"
...
| <code><a href="#@cdktf/provider-okta.oauthAppRedirectUri.OauthAppRedirectUri.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-okta.oauthAppRedirectUri.OauthAppRedirectUriConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
