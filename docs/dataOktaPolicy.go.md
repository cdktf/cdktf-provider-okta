...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v11/dataoktapolicy"
...
| <code><a href="#@cdktf/provider-okta.dataOktaPolicy.DataOktaPolicyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.1/docs/data-sources/policy#id DataOktaPolicy#id}. |
