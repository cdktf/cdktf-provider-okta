...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/dataoktagroups"
...
| <code><a href="#@cdktf/provider-okta.dataOktaGroups.DataOktaGroupsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/groups#id DataOktaGroups#id}. |
