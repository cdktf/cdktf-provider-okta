...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v9/appgroupassignment"
...
&appgroupassignment.AppGroupAssignmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v9.appGroupAssignment.AppGroupAssignmentTimeouts,
}
```
