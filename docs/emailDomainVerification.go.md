...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v11/emaildomainverification"
...
| <code><a href="#@cdktf/provider-okta.emailDomainVerification.EmailDomainVerificationConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.3.0/docs/resources/email_domain_verification#id EmailDomainVerification#id}. |
