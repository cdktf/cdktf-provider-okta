...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/socialidp"
...
| <code><a href="#@cdktf/provider-okta.socialIdp.SocialIdp.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
