...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v14/dataoktabehavior"
...
Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.19.0/docs/data-sources/behavior#import import section} in the documentation of this resource for the id to use
