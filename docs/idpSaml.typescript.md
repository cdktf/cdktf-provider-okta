...
```typescript
public resetHonorPersistentNameId(): void
```
...
| <code><a href="#@cdktf/provider-okta.idpSaml.IdpSaml.property.honorPersistentNameIdInput">honorPersistentNameIdInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-okta.idpSaml.IdpSaml.property.honorPersistentNameId">honorPersistentNameId</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly honorPersistentNameIdInput: boolean | IResolvable;
```
...
```typescript
public readonly honorPersistentNameId: boolean | IResolvable;
```
...
| <code><a href="#@cdktf/provider-okta.idpSaml.IdpSamlConfig.property.honorPersistentNameId">honorPersistentNameId</a></code> | <code>boolean \| cdktf.IResolvable</code> | Determines if the IdP should persist account linking when the incoming assertion NameID format is urn:oasis:names:tc:SAML:2.0:nameid-format:persistent. |
