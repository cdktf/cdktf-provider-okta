...
Refer to the Terraform Registory for docs: [`okta_admin_role_custom`](https://registry.terraform.io/providers/okta/okta/4.1.0/docs/resources/admin_role_custom).
...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/adminrolecustom"
...
| <code><a href="#@cdktf/provider-okta.adminRoleCustom.AdminRoleCustomConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/resources/admin_role_custom#id AdminRoleCustom#id}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/resources/admin_role_custom#id AdminRoleCustom#id}.
