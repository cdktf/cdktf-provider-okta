...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/securitynotificationemails"
...
| <code><a href="#@cdktf/provider-okta.securityNotificationEmails.SecurityNotificationEmailsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/resources/security_notification_emails#id SecurityNotificationEmails#id}. |
