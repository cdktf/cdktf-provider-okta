...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v6/user"
...
| <code><a href="#@cdktf/provider-okta.user.User.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
```go
func GroupMembershipsInput() *[]*string
```
...
&user.UserConfig {
	...
	Organization: *string,
	Password: *string,
	PasswordHash: github.com/cdktf/cdktf-provider-okta-go/okta/v6.user.UserPasswordHash,
...
| <code><a href="#@cdktf/provider-okta.user.UserConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-okta.user.UserConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/r/user#id User#id}. |
