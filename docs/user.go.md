...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v11/user"
...
&user.UserConfig {
	...
	Organization: *string,
	Password: *string,
	PasswordHash: github.com/cdktf/cdktf-provider-okta-go/okta/v11.user.UserPasswordHash,
...
| <code><a href="#@cdktf/provider-okta.user.UserConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.2/docs/resources/user#id User#id}. |
