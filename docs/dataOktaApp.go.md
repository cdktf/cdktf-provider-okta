...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v11/dataoktaapp"
...
| <code><a href="#@cdktf/provider-okta.dataOktaApp.DataOktaApp.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
