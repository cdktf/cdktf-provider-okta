...
Refer to the Terraform Registory for docs: [`okta_email_customization`](https://registry.terraform.io/providers/okta/okta/4.1.0/docs/resources/email_customization).
...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/emailcustomization"
