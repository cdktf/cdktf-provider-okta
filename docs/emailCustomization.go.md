...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v14/emailcustomization"
...
Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/email_customization#import import section} in the documentation of this resource for the id to use
