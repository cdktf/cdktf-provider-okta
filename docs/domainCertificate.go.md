...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/domaincertificate"
...
| <code><a href="#@cdktf/provider-okta.domainCertificate.DomainCertificateConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/resources/domain_certificate#id DomainCertificate#id}. |
