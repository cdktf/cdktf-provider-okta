...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v7/bookmarkapp"
...
&bookmarkapp.BookmarkAppConfig {
	...
	SkipUsers: interface{},
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v7.bookmarkApp.BookmarkAppTimeouts,
	Users: interface{},
}
```
