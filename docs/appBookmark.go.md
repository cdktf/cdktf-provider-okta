...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/appbookmark"
...
&appbookmark.AppBookmarkConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v8.appBookmark.AppBookmarkTimeouts,
}
```
