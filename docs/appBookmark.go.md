...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v7/appbookmark"
...
&appbookmark.AppBookmarkConfig {
	...
	SkipUsers: interface{},
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v7.appBookmark.AppBookmarkTimeouts,
	Users: interface{},
}
```
...
| <code><a href="#@cdktf/provider-okta.appBookmark.AppBookmarkConfig.property.requestIntegration">RequestIntegration</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/3.46.0/docs/resources/app_bookmark#request_integration AppBookmark#request_integration}. |
