...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v9/appbookmark"
...
&appbookmark.AppBookmarkConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v9.appBookmark.AppBookmarkTimeouts,
}
```
