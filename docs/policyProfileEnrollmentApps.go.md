...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/policyprofileenrollmentapps"
...
| <code><a href="#@cdktf/provider-okta.policyProfileEnrollmentApps.PolicyProfileEnrollmentAppsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.0/docs/resources/policy_profile_enrollment_apps#id PolicyProfileEnrollmentApps#id}. |
