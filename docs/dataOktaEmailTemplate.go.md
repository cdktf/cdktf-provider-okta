...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/dataoktaemailtemplate"
...
| <code><a href="#@cdktf/provider-okta.dataOktaEmailTemplate.DataOktaEmailTemplateConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/data-sources/email_template#id DataOktaEmailTemplate#id}. |
