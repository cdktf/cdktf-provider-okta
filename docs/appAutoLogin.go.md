...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v6/appautologin"
...
&appautologin.AppAutoLoginConfig {
	...
	SkipUsers: interface{},
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v6.appAutoLogin.AppAutoLoginTimeouts,
