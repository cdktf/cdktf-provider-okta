...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/appautologin"
...
&appautologin.AppAutoLoginConfig {
	...
	SignOnUrl: *string,
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v10.appAutoLogin.AppAutoLoginTimeouts,
