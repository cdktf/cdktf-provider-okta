...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v5/appautologin"
...
&appautologin.AppAutoLoginConfig {
	...
	SkipUsers: interface{},
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v5.appAutoLogin.AppAutoLoginTimeouts,
