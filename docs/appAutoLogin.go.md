...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v14/appautologin"
...
&appautologin.AppAutoLoginConfig {
	...
	SignOnUrl: *string,
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v14.appAutoLogin.AppAutoLoginTimeouts,
