...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/ratelimiting"
...
| <code><a href="#@cdktf/provider-okta.rateLimiting.RateLimitingConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.0/docs/resources/rate_limiting#id RateLimiting#id}. |
