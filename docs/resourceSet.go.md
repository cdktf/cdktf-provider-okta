...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v8/resourceset"
...
| <code><a href="#@cdktf/provider-okta.resourceSet.ResourceSetConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.0/docs/resources/resource_set#id ResourceSet#id}. |
