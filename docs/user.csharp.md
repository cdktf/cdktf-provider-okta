...
```csharp
private void ResetGroupMemberships()
```
...
| <code><a href="#@cdktf/provider-okta.user.User.property.count">Count</a></code> | <code>double</code> | *No description.* |
...
```csharp
public string[] GroupMembershipsInput { get; }
```
...
| <code><a href="#@cdktf/provider-okta.user.UserConfig.property.count">Count</a></code> | <code>double</code> | *No description.* |
