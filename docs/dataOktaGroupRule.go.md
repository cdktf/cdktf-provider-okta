...
Refer to the Terraform Registory for docs: [`data_okta_group_rule`](https://registry.terraform.io/providers/okta/okta/4.1.0/docs/data-sources/group_rule).
...
Represents a {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/data-sources/group_rule okta_group_rule}.
...
| <code><a href="#@cdktf/provider-okta.dataOktaGroupRule.DataOktaGroupRuleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/data-sources/group_rule#id DataOktaGroupRule#id}. |
| <code><a href="#@cdktf/provider-okta.dataOktaGroupRule.DataOktaGroupRuleConfig.property.name">Name</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/data-sources/group_rule#name DataOktaGroupRule#name}. |
| <code><a href="#@cdktf/provider-okta.dataOktaGroupRule.DataOktaGroupRuleConfig.property.status">Status</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/data-sources/group_rule#status DataOktaGroupRule#status}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/data-sources/group_rule#id DataOktaGroupRule#id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/data-sources/group_rule#name DataOktaGroupRule#name}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.1.0/docs/data-sources/group_rule#status DataOktaGroupRule#status}.
