...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v10/orgconfiguration"
...
| <code><a href="#@cdktf/provider-okta.orgConfiguration.OrgConfigurationConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.2/docs/resources/org_configuration#id OrgConfiguration#id}. |
