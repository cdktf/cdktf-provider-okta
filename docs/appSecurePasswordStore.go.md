...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v14/appsecurepasswordstore"
...
&appsecurepasswordstore.AppSecurePasswordStoreConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-okta-go/okta/v14.appSecurePasswordStore.AppSecurePasswordStoreTimeouts,
