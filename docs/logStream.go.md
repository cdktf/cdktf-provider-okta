...
```go
import "github.com/cdktf/cdktf-provider-okta-go/okta/v14/logstream"
...
Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.20.0/docs/resources/log_stream#import import section} in the documentation of this resource for the id to use
...
&logstream.LogStreamConfig {
	...
	Name: *string,
	Type: *string,
	Settings: github.com/cdktf/cdktf-provider-okta-go/okta/v14.logStream.LogStreamSettings,
	Status: *string,
}
```
